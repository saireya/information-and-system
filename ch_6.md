...
また、代表的な創発過程である問題解決と、問題解決で用いられるモデルについて述べる。
...
Simon\[[simon2]\]によれば、 **問題** (**problem**)は、 *理想的な状態* (*To-Be*)と *現在の状態* (*As-Is*)の間に *差* があることである。
...
つまり、 *システムのあらゆる現象は本来、総和的に説明できる* という前提に立ちつつ、現時点で人間が持つ理論では説明できないことを創発性と呼んでいる\[[malaterre]\]。
