...
このアイデアをどう他の情報と関連付けるか、つまり相互の関連性を見出すかが重要であることは、上述のYoungの主張と同様である。
...
これらの方法に共通するのは、生み出された *アイデアの吟味や検討を同時には行わず、一通りアイデアが出た後でまとめて行う* 点である。
アイデアの産出と吟味を同時あるいは交互に行うと、思考やコミュニケーションが同じ範囲を何度も行き来するため、アイデアの幅が広まらない。
また、吟味や検討は批判的な姿勢で行う必要があるため、思考が萎縮して突飛なアイデアが生まれにくくなる。
加えて、吟味と産出を繰り返して行うと、思考の切り替えに時間を要するため、創発の効率自体が低くなる。
これらの方法により、 *思考を広げる段階* と *思考を深める段階* を明確に区分し、集団の個性を引き出すコミュニケーションを支援することが、斬新で優れたアイデアを生み出すことに繋がるといえる。
